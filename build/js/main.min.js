...
require("./modules/swiper-coaches/swiper-coaches");
require("./modules/accordion/index");
require("./modules/swiper-reviews/swiper-reviews");
...
},{"./modules/accordion/index":3,"./modules/scroll/scroll":5,"./modules/swiper-coaches/swiper-coaches":6,"./modules/swiper-reviews/swiper-reviews":7,"./modules/tabs/index":8,"./modules/youtube-video/youtube-video":11,"./utils/ios-vh-fix":13}],2:[function(require,module,exports){
"use strict";
...
var buyTicketLink = document.getElementById('buy-ticket');
buyTicketLink.addEventListener('click', function () {
...
},{"./init-tabs":9}],9:[function(require,module,exports){
"use strict";
...
var iframe = document.querySelector('.gym__iframe-wrapper');
iframe.remove();
var poster = document.querySelector('.gym__poster-wrapper');
