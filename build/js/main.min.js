...
var _swiperCoaches = require("./modules/swiper-coaches/swiper-coaches");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _swiperCoaches.initCoachesSwiper)();
    (0, _initAccordion.initAccordions)();
    (0, _swiperReviews.initReviewsSwiper)();
  });
});

},{"./modules/accordion/init-accordion":3,"./modules/scroll/scroll":4,"./modules/swiper-coaches/swiper-coaches":5,"./modules/swiper-reviews/swiper-reviews":6,"./modules/tabs/init-tabs":7,"./modules/youtube-video/youtube-video":9,"./utils/ios-vh-fix":11}],2:[function(require,module,exports){
"use strict";
